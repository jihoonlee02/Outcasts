...
public class CameraShake : MonoBehaviour
{
    ...
    [SerializeField, Range(0.1f,20f)] public float m_strength = 0.1f;
    ...
    public void StartShaking(float strength = 0.1f)
    {
        m_strength = strength;
        //m_radius = radius;
        //m_speed = speed;
    ...
    public void StartShakingFor(float seconds, float strength = 0.25f)
    {
        StartShaking(strength);
        StartCoroutine(ShakeFor(seconds));
    }
